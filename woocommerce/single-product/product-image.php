        ...
        <ul class="splide__list">
            <?php if (!empty($attachment_ids)): ?>
                <?php foreach ($attachment_ids as $attach) : ?>
                    <?php $url = wp_get_attachment_image_src($attach, 'full'); ?>
                    <li class="images-item splide__slide">
                        <img src="<?php echo $url[0]; ?>" alt="<?php echo $product->get_name(); ?>">
                    </li>
                <?php endforeach; ?>
            <?php endif; ?>
        </ul>
...
<div class="splide product-gallery__thumbs">
    <div class="splide__track">
        <ul class="splide__list">
            <?php if (!empty($attachment_ids)): ?>
                <?php foreach ($attachment_ids as $attach) : ?>

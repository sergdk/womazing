<div id="cart-container" class="cart-container">
    ...
    <div class="cart-block">
        <h3 class="cart-block-title">
            <?php _e('Кошик', 'womazing'); ?>
        </h3>
            ...
            <div class="cart-content__main" v-if="isEmpty != false">
                ...
                <div class="cart-footer">
                    <div class="cart-footer-content">
                        <h4>
                            <?php _e('Разом:', 'womazing'); ?>
                        </h4>
                        <span v-if="couponIsEmpty === false" style="margin-left: 10px;">
                            <?php _e('(з купоном)', 'womazing'); ?>
                        </span>
                        <span class="sum">
                    ...
                    <div class="cart-footer-btns">
                        <div class="btn-show-bag">
                            <a href="<?php echo wc_get_cart_url();  ?>">
                                <?php _e('Переглянути кошик', 'womazing'); ?>
                            </a>
                        </div>
                        <div class="btn-purchase">
                            <a href="<?php echo wc_get_checkout_url();  ?>">
                                <?php _e('Перейти до оплати', 'womazing'); ?>
                            </a>
                        </div>
                    </div>
                </div>
